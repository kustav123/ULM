...
<?php require_once "config.php"; ?>
        <div class="container">          
                 ...
                 <div class="col-lg-12">  
                 <div class="card shadow-lg bg-info border-0 rounded-lg mt-5">  
                 <div class="card-header"><h3 class="text-center font-weight-light text-info my-4">Follow Up</h3></div>
                                    <div class="card-body">            
                                                       ...
                                                       // require_once "config.php";
                                                        ...
                                                        if($result = mysqli_query($link, $sql)){
                                                            if(mysqli_num_rows($result) > 0){
                                                              ...
                                                              echo '<table class="table table-bordered table-striped table-success table-sm" cellspacing="0" width="100%">';                             
                                    ...
                                    <div id="follow-two" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                      ...
                                      <div class="accordion-item">
                                        ...
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#follow-three" aria-expanded="false" aria-controls="flush-collapseThree">
                                            More then 2 Days 
                                        </button>
                                    </h2>
                                    <div id="follow-three" class="accordion-collapse collapse " aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                              <div class="accordion-body">    
