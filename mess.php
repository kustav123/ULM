                    ...
                    <div class="col-lg-6">
                        <div class="card shadow-lg bg-info text-white border-0 rounded-lg mt-5">
                            <div class="card-header">
                                <h3 class="text-center font-weight-light text-info my-4">Send Notification</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" maxlength="20" name="subject" id="subject"
                                                    class="form-control <?php echo (!empty($subject_no_err)) ? 'is-invalid' : ''; ?>"
                                                    value="<?php echo $subject_no; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="messages" maxlength="150"
                                                class="form-control <?php echo (!empty($messages_err)) ? 'is-invalid' : ''; ?>"><?php echo $messages; ?></textarea>
                                        ...
                                        <link
                                            href="https://cdn.jsdelivr.net/npm/bootstrap-multiselect@0.9.15/dist/css/bootstrap-multiselect.min.css"
                                            rel="stylesheet">
                                        <!-- Required JS for Bootstrap multiselect -->
                                        <script
                                            src="https://cdn.jsdelivr.net/npm/bootstrap-multiselect@0.9.15/dist/js/bootstrap-multiselect.min.js">
                                        </script>
