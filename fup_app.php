...
?>  
  <div id="layoutSidenav_content">
        ...
        <div class="container">          
                 ...
                 <div class="card-header"><h3 class="text-center font-weight-light my-4 text-info">Follow Up</h3></div>
                                    <div class="card-body">  
                                    ...
                                    <div class="accordion accordion-flush" id="accordionFlushExample">
                                        ...
                                        <div id="follow-one" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlush">
