...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(isset($_POST["name"])){
        ...
        $cou_name_err = "Select Customer First.";
    ...
    if(isset($_POST["executive"])){
        ...
        $executive_err = "Select Executive";
    }
    ...
    if(isset($_POST["product"])){
        ...
        $product_err = "Select Product";
    }
    $input_time = trim($_POST["time"]);
    if(empty($input_time)){
        $time_err = "Select Out time";
    ...
    if(empty($cou_name_err) && empty($executive_err )  && empty($product_err) && empty($product_err) && empty($time_err) ) {
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
               ...
               logActivity('Add', 'OutCustomer', 'Customer Exit ' . $cou_id .' by '.  $_SESSION["username"] , $_SESSION["id"] );    
                                    ...
                                    <input type="hidden" name="cname" class="form-control" id="cname" >
                                         ...
                                         <div class="row">
                                           ...
                                           <div class="row">
                                               ...
                                               <a href="out.php" class="btn btn-secondary ml-2">Cancel</a>
