                        ...
                        <div class="col-lg-8">
                            <div class="card shadow-lg text-white border-0 rounded-lg mt-3 mb-2" style="width: auto;">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light text-info my-4">User List</h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                    $from = "";
                                    ...
                                    $sql = "SELECT u.*, r.name as rolename FROM users u, role r where u.role = r.id;";
                                    ...
                                    if ($result = mysqli_query($link, $sql)) {
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo '&nbsp&nbsp<a href="ajax.php?uidd=' . $row['id'] . '" class="mr-3" title="Disable user" data-toggle="tooltip"><span class="fa fa-ban"></span></a>';

                                                echo '&nbsp&nbsp<a href="updateu.php?uid=' . $row['id'] . '" class="mr-3" title="Update User" data-toggle="tooltip"><span class="fa fa-edit"></span></a>';
                                                echo "</td>";
                                                echo "</tr>";
                                            }
                                            echo "</tbody>";
    ...
    $(document).ready(function() {
      $("#myTableWrapper table").DataTable({
        "pageLength": 10
                                    ...
                                    <a class="btn btn-primary" href="register.php" role="button"><ion-icon
                                            name="add-outline"></ion-icon>Add User</a>
                                </div>
                            </div>
                        </div>
                    </div>
